...
[
    ...
    [ "Asha", 
        ...
        "projects/asha.html", 
        "projects/asha/asha.jpg",
        [ "asset", "Blender", "pixel-art" ],
        [ "art", "tech art" ],
        "https://oculometric.artstation.com/projects/kNbxgy", "Artstation" ],
    [ "BUNNY.OBJ", 
        "Aug 2025", 
        "a stylised game ready bunny asset.", 
        "projects/bunny.html", 
        "projects/bunny-flying.gif",
        [ "asset", "Blender", "pixel-art", "space" ],
        [ "art" ],
        "https://oculometric.artstation.com/projects/vbP9G6", "Artstation" ],
    [ "origami-sunset", 
        "Apr 2025 - ongoing", 
        "a night-sky constellation map rendering tool written in pure C++.", 
        "projects/origami-sunset.html", 
        "projects/origami-sunset.jpg",
        [ "C++", "graphics", "math", "space" ],
        [ "programming", "graphics" ],
        "https://github.com/oculometric/origami-sunset", "Github" ],
    [ "CAMCORDER.OBJ", 
        "May 2025", 
        "a stylised camcorder asset, based on the Canon MVX25i.", 
        "projects/camcorder.html", 
        "projects/camcorder/camcorder-showreel.gif",
        [ "asset", "Blender", "pixel-art" ],
        [ "art" ],
        "https://oculometric.artstation.com/projects/oJP3zz", "Artstation" ],
    [ "Rod and Ripple", 
        "Mar - May 2025", 
        "a semi-open-world fishing game, made for the Staffs collaborative game development module.", 
        "projects/rod-and-ripple.html", 
        "projects/ror/ror.jpg",
        [ "UE5", "tech-art", "collaborative" ],
        [ "tech art", "games" ],
        "https://oculometric.itch.io/rod-and-ripple", "Itch" ],
    [ "STUI", 
        "Aug 2024 - ongoing", 
    ...
    [ "framework-renderer", 
        "Oct 2024 - Feb 2025", 
        "a DirectX 11 graphics engine showcasing some common graphics techniques, built for a second year uni module.", 
        "projects/framework-renderer.html", 
        "projects/framework-renderer.jpg",
        [ "C++", "graphics", "DX11" ],
        [ "programming", "graphics" ],
        "https://github.com/oculometric/framework-renderer", "Github" ],
    [ "\'connect\'", 
        "Jul 2024", 
    ...
    [ "GL 1.X space game", 
        ...
        [ "C++", "graphics", "OpenGL", "space" ],
        [ "programming", "graphics" ],
        "https://github.com/oculometric/GP-Assessment-1", "Github" ],
    [ "gallery study", 
        "Mar 2024", 
        "a stylised museum room.", 
        "projects/gallery-study.html", 
        "projects/gallery/isometric.jpg",
        [ "art", "Blender", "space" ],
        [ "art" ],
        "https://github.com/oculometric/planetarium", "Github" ],
...
function enumerateProjects(filter_name)
{
    ...
    {
        elmnt = z[i];
        if (elmnt.hasAttribute("filter-label"))
        {
            if (filter)
                elmnt.innerHTML = "filter: " + filter;
            else
                elmnt.innerHTML = "filter: none";
        }
        else if (elmnt.hasAttribute("project-div"))
        {
            elmnt.innerHTML = "";
            for (var inputs of projects)
            {
                ...
                var image = inputs[4];
                var tags = inputs[5];
                var categories = inputs[6];
                var alt_link = inputs[7];
                var alt_link_name = inputs[8];
